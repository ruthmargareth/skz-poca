...
export default function Add() {
  ...
  const handleSubmit = async (e) => {
    ...
    const imageUrlFront = await uploadToCloudinary(imageFront);
    const imageUrlBack = await uploadToCloudinary(imageBack);
  ...
  return (
    <div className="w-full pt-15">
      <div className="max-w-7xl mx-auto rounded-md shadow-md">
        <h1 className="text-2xl font-bold mb-2 pl-5 pt-5">ADD PHOTOCARD</h1>
